...
begin
	...
	if(rst_n = '1') then
			...
			mem(2)    <= "0001011011000000"; --add r1 + r2= r3
			mem(3)    <= "0111110000111111"; --store r3 na posição 63 da memoria
			mem(4)    <= "1000000000001000"; -- jump para posição 8
			mem(5)    <= "0000000000000000"; 
			mem(6)    <= "0000000000000000";
			mem(7)    <= "0000000000000000";
			mem(8)    <= "1100100100000010";--bne r1 com r2 para posição 56
