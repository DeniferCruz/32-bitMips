...
entity data_path is
  Port (
    ...
    alu_a_ind           : in std_logic; --não foi usado
    alu_b_ind           : in std_logic; --não foi usado
...
architecture rtl of data_path is
    ...
    signal data                 : std_logic_vector (15 downto 0);--não foi usado
    signal alu_or_mem_data      : std_logic_vector (15 downto 0);--não foi usado
    signal instruction          : std_logic_vector (15 downto 0); -- processo
    signal mem_addr             : std_logic_vector (5  downto 0);--endereço 
    signal program_counter      : std_logic_vector (5  downto 0);--não foi usado 
    signal b_alu                : std_logic_vector (15 downto 0);--não foi usado
    ...
    -- banco de registradores
     ...
     signal reg_inst_mem        : std_logic_vector (14 downto 0);--não foi usado
     signal mem_data_reg        : std_logic_vector (15 downto 0); --não foi usado
     ...
     signal reg_ula_out         : std_logic_vector (15 downto 0); --não foi usado
   ...
   -- ALU signals
    signal a_operand    : STD_LOGIC_VECTOR (15 downto 0); --não foi usado     
    signal b_operand    : STD_LOGIC_VECTOR (15 downto 0);  --não foi usado 
